...
public class AccountService {
	...
	// 거래처 필터 데이터 조회
	public List<Map<String, Object>> select_FILTERED_ACCOUNT(AccountFilterRequest filterRequest) {
		
		List<Object[]> result;
		
		result = accountRepository.select_FILTERED_ACCOUNT(filterRequest);
    ...
    // 거래처 삭제(거래처 사용여부 미사용)
	public void updateAccountStatus(List<String> accountCds, String status) {
		accountRepository.updateAccountStatus(accountCds, status);
	}
    
	
	public List<Map<String, Object>> select_ACCOUNT_PS() {

		List<Object[]> result;

		result = accountRepository.select_ACCOUNT_PS();
	...
	public List<Map<String, Object>> search_ACCOUNT_PS(String keyword) {
		
		List<Object[]> result;
		
		result = accountRepository.search_ACCOUNT_PS(keyword);
